...
public class DateUtil {
    ...
    public static SimpleDateFormat yyyyMMddHHmmss_ = new SimpleDateFormat(yymmddhhmmss);
    ...
    public static SimpleDateFormat yyyyyearMMmonthddday = new SimpleDateFormat("yyyy年MM月dd日");
     ...
     * @return String
     */
    public static String getCurrentStringTime_() {
        return yyyyMMddHHmmss_.format(new Date());
    }
    ...
    public static String getYearMongthDay() {
        return yyyyyearMMmonthddday.format(new Date());
    }
    ...
    public static Date getSysTime() {
        return DateUtil.stringToDate(getCurrentStringTime(), ymdhms);
    }
    ...
    public static Date getSysDate() {
        return DateUtil.stringToDate(getCurrentStringTime(), ymd);
    }
    ...
    public static Date getNextMinu(Date date) {
        Calendar calendar = Calendar.getInstance();
     ...
     * @return Date
     */
    public static Date getHourZeroMinute() {
        Calendar cal = Calendar.getInstance();
        cal.set(Calendar.SECOND, 0);
        cal.set(Calendar.MINUTE, 0);
     ...
     * @return Date
     */
    public static Date getTimeZeroMinute(long time) {
        Calendar cal = Calendar.getInstance();
     ...
     * @return
     */
    public static Date getTimeZeroHour(long time) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(time);
        cal.set(Calendar.SECOND, 0);
        cal.set(Calendar.MINUTE, 0);
     ...
     * @return
     */
    public static Date getTimeYesterDayZeroHour(long time) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(time);
        cal.add(Calendar.DATE, -1);
        cal.set(Calendar.SECOND, 0);
     ...
     * @return
     */
    public static Date getTimeTomorrowZeroHour(long time) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(time);
        cal.add(Calendar.DATE, +1);
        cal.set(Calendar.SECOND, 0);
     ...
     * @return
     */
    public static Date getTimeZeroDay(long time) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(time);
     ...
     * @return
     */
    public static Date getTimeNextMonthZeroDay(long time) {
        Calendar cal = Calendar.getInstance();
        cal.setTimeInMillis(time);
